...
/**
 * An extension of WDesktopPane that supports often used MDI functionality. This class also handles setting scroll bars
 * for when windows move too far to the left or bottom, providing the MDIDesktopPane is in a ScrollPane.
 */
