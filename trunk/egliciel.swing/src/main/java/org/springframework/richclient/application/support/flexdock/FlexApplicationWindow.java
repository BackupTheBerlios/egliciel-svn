 ...
 *
 */
public class FlexApplicationWindow extends DefaultApplicationWindow {

    protected ApplicationPage createPage(PageDescriptor descriptor) {
        return new FlexApplicationPage(this, descriptor);
        
    }
    /*
    protected JMenuBar createMenuBarControl() {
        JMenuBar menuBar = super.createMenuBarControl();
        menuBar.putClientProperty(PlasticLookAndFeel.IS_3D_KEY, new Boolean( true));
